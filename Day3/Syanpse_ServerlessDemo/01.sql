...
, SECRET = 'sp=rwl&st=2022-03-03T05:45:43Z&se=2022-03-09T13:45:43Z&spr=https&sv=2020-08-04&sr=c&sig=%2BuVY1n0KlObCO5AJHoJ%2Bxhu4FNB440kAKnPgCKD4mJM%3D';

-- This defines the source of the data. 

CREATE EXTERNAL DATA SOURCE log_data
WITH (    LOCATION   = 'https://forbigdataanalysis.blob.core.windows.net/testblob',
          CREDENTIAL = SasToken
)
